            ...
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-3">
                ...
                <div className="space-y-2 mt-4">
                    <div className="flex items-center space-x-2 justify-center">
                        <img src="https://png.pngtree.com/png-clipart/20230923/original/pngtree-book-logo-template-logo-book-education-vector-png-image_12530726.png" alt="" width="40" height="40" className="hover:cursor-pointer" />
                    </div>
                    <p>Ha Noi, Viet Nam</p>
